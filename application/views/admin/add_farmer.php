                                            ...
                                            <form action="#" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="control-group">
                                                    <textarea class="form-control" rows="1" id="" name=""
                                                        ...
                                                        data-validation-required-message="Please enter you Land Area"></textarea>
                                                    <p class="help-block text-danger"></p>
                                                </div>

                                                <div class="control-group">
                                                    <textarea class="form-control" rows="1" id="" name=""
                                                        placeholder="seller_product"
                                                        data-validation-required-message="Please enter you seller_product"></textarea>
                                                    <p class="help-block text-danger"></p>
                                                </div>
                                                <hr>
