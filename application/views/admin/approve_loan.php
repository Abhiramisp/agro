                                                    ...
                                                    <div class="col-sm-12 col-md-6 ">
                                                        <div class="control-group">
                                                            <input type="text" class="form-control" id="fname"
                                                                name="fname" placeholder="Farmer Name"
                                                                required="required"
                                                    ...
                                                    <div class="col-sm-12 col-md ">
                                                        <div class="control-group">
                                                            <input type="" class="form-control" id="" name=""
                                                                ...
                                                                data-validation-required-message="Please enter Bank Name" />
                                                            <p class="help-block text-danger"></p>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md ">
                                                        <div class="control-group">
                                                            <input type="email" class="form-control" id="" name=""
                                                                placeholder="Bank Email" required="required"
                                                                data-validation-required-message="Please enter Bank email" />
                                                            <p class="help-block text-danger"></p>
                                                        </div>
                                                    </div>
                                                </div>
