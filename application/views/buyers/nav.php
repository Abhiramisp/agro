    ...
    <div class="container-fluid fixed-top">
        ...
        <div class="container px-0">
            <nav class="navbar navbar-light bg-white navbar-expand-xl">
                <a href="Buyer_homePage" class="navbar-brand">
                ...
                <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                    <div class="navbar-nav mx-auto">
                        <a href="Buyer_homePage" class="nav-item nav-link active">Home</a>
                    ...
                    <div class="d-flex m-3 me-0">
                        ...
                        <div class="nav-item ">
                            ...
                            <div class="dropdown-menu bg-secondary rounded-0">
                                ...
                                <a href="Buyer_transactionHistory" class="dropdown-item">Transaction history</a>
