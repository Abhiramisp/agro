                                        ...
                                        <form action="#" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="col-sm-12 col-md-6 col-lg">
                                                    <div class="control-group ">
                                                        ...
                                                        <select class="form-control bg-white" id="fcity" name="fcity"
                                                            ...
                                                            <option value="<?php echo $sqldata1[0]->b_city; ?>" disabled
                                                                selected>
                                                    ...
                                                    <div class="control-group">
                                                        <select class="form-control bg-white" id="ftaluk" name="ftaluk"
                                                            ...
                                                            <option class="form-control"
                                                                value="<?php echo $sqldata1[0]->b_taluk; ?>" disabled
                                                                selected>
                                            ...
                                            <div class="control-group">
                                                <textarea class="form-control" rows="1" id="" name=""
                                                    placeholder="<?php echo $sqldata1[0]->b_shipping_loc; ?>"
                                            ...
                                            <div class="control-group">
                                                <textarea class="form-control" rows="1" id="" name=""
                                                    placeholder="<?php echo $sqldata1[0]->b_company_name; ?>"
                                            ...
                                            <div class="control-group">
                                                <textarea class="form-control" rows="1" id="" name=""
                                                    placeholder="<?php echo $sqldata1[0]->b_company_loc; ?>"
                                                    value="<?php echo $sqldata1[0]->b_company_loc; ?>"
                                            ...
                                            <div class="control-group">
                                                <input class="form-control" id="" name=""
                                                    placeholder="<?php echo $sqldata1[0]->b_gst_number; ?>"
                                                    value="<?php echo $sqldata1[0]->b_gst_number; ?>"
