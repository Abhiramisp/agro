            ...
            <section>
                ...
                <div class="container-fluid py-5">
                    <div class="container" style="max-width: 900px;">
                        <h3 class="justify-content-center "> Requerment </h3>
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="contact-form">
                                    ...
                                    <form action="#" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="">
                                                <div class="control-group">
                                                    <textarea type="email" class="form-control" id="fmail" name="fmail"
                                                        placeholder="Product Discription" rows="3"
                                        ...
                                        <div class="control-group">
                                            <input type="text" class="form-control" id="fmobile" name="fmobile"
                                                placeholder="Organic/Inorganic"
                                                data-validation-required-message="Please enter Organic/Inorganic" />
                                            <p class="help-block text-danger"></p>
                                        </div>
